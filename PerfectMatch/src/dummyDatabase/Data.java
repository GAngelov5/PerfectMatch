...
public class Data implements Serializable{
	...
	private static final long serialVersionUID = -8657672785906406535L;
	
	public static DataInitializer data = new DataInitializer();
...
//		
//	
//		users.add(new User("Stella", "123456", "www.facebook.com/stela", "f",this.customStella()));
...
//		users.add(new User("Milena","qwerty","www.facebook,com/milencheto","f",this.custom(1)));
//		
...
//		answers.add(new Answer(2, "Several years/rest of my life",2,questions.get(0)));
//		
...
//		answers.add(new Answer(8, "Below average", 2, questions.get(2)));
//		
//		answers.add(new Answer(9, "Extreamly important",0,questions.get(3)));
//		answers.add(new Answer(10, "Somewhat",1,questions.get(3)));
//		answers.add(new Answer(11, "Not at all",2,questions.get(3)));
//		
//		answers.add(new Answer(12, "Always",0,questions.get(4)));
//		answers.add(new Answer(13, "Usually",1,questions.get(4)));
//		answers.add(new Answer(14, "Rarely/Never",2,questions.get(4)));
//		
